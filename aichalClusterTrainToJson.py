...
def showBox(image_set, thresh):
    cache_file =  \
        'output/kpCluster/aichal2_train/zf_faster_rcnn_iter_100000_inference/detections.pkl'
    ...
    with open ('pred_cluster_train_' + str(thresh) +'.json', 'w') as f:
        json.dump(data, f)

if __name__ == '__main__':
    thresh = [0.3, 0.5, 0.7, 0.9]
    for t in thresh:
        showBox('aichal2_2017_train', t)
