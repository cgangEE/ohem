...
def getName2Box():
    name2box = {}
    fValDetail = open('data/psdbCrop/val_detail.txt', 'r')
...
def getName2Det(cache_file):
    ...
    psdbCrop = get_imdb('psdbCrop_2015_val')
    name2det = {}
...
if __name__ == '__main__':
    ...
    for i in range(10, 9, -1):
        print("Iteration", i)
        cacheFilename = \
               'output/pvanet_full1_ohem_DRoiAlignX/psdbCrop_val/zf_faster_rcnn_iter_' + str(i) + \
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('psdbCrop-psdbFourParts-fppi0.1-Ohem-pvanet-DRoiAlignX-' + str(i) +'.pkl')
