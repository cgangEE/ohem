...
template <typename Dtype>
class ROIAlignHalfLayer : public Layer<Dtype> {
 public:
  explicit ROIAlignHalfLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ROIAlignHalf"; }
...
template <typename Dtype>
class ProposalClusterLayer : public Layer<Dtype> {
 public:
  explicit ProposalClusterLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "ProposalClusterLayer"; }
