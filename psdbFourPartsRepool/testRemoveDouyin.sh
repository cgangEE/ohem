for i in {10..10}
do
	echo 'Testing'  $i &>> log_psdbFourParts_Ohem_DRoiAlignX_RepoolRemove_douyin_test_${i}
	tools/test_net_four_parts_repoolRemove.py \
		...
		--imdb douyin_2015_test  &>> log_psdbFourParts_Ohem_DRoiAlignX_RepoolRemove_douyin_test_${i} 
done
