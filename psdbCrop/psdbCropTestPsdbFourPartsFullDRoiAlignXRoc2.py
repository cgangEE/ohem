...
def getName2Box():
    name2box = {}
    fValDetail = open('data/psdbCrop/test_detail.txt', 'r')
...
def getName2Det(cache_file):
    ...
    psdbCrop = get_imdb('psdbCrop_2015_test')
    name2det = {}
...
#        det[:, 4] *= bbox[4]
        ...
        imagename = imagename.split('_')[0] + '.jpg'
...
if __name__ == '__main__':
    ...
    for i in range(10, 9, -1):
        print("Iteration", i)
        cacheFilename = \
               'output/pvanet_full1_ohem_DRoiAlignX/psdbCrop_test/zf_faster_rcnn_iter_' + str(i) + \
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('psdbCrop-psdbFourParts-groundTruth-Ohem-pvanet-DRoiAlignX-' + str(i) +'.pkl')
