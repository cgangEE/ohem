...
def getName2Box():
    name2box = {}
    fValDetail = open('data/psdbCrop/val2_detail.txt', 'r')
...
def getName2Det(cache_file):
    ...
    psdbCrop = get_imdb('psdbCrop_2015_val2')
    name2det = {}
...
if __name__ == '__main__':
    ...
    for i in range(10, 9, -1):
        print("Iteration", i)
        cacheFilename = \
               'output/pvanet_full1_ohem_DRoiAlignX/psdbCrop_val2/zf_faster_rcnn_iter_' + str(i) + \
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('psdbCrop-psdbFourParts-All-Ohem-pvanet-DRoiAlignX-' + str(i) +'.pkl')
