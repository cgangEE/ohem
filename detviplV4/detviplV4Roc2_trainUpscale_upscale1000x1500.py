...
if __name__ == '__main__':
    ...
    for i in range(10, 11):
        print("Iteration", i)
        cacheFilename = \
             'output/pvanet_full1_upscale1000x1500/detviplV4_test/detvipl_v4_upscale_100000_inference/detections.pkl'
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('detviplV4-pvanet-ohem-trainUpscale_1000x1500.pkl')
