...
if __name__ == '__main__':
    ...
    folderList = ['pvanet_full1_svd', 'pvanet_full1_svd_1000x1500', \
                'pvanet_full1_svd_1500x2000']


    for folder in folderList:

        cacheFilename = \
            'output/' + folder + '/detviplV4_test/detvipl_v4_upscale_100000_inference_svd_fc6_512_fc7_512/detections.pkl'
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join(folder + '.pkl')
