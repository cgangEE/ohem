...
def showImage(im, boxes):
    ...
    threshold = [0, 0.87817317, 0.76001126, 0.8020515, 0.48905125]
...
def tattooShowBox(image_set):
    cache_file =  \
        'output/pvanet_full1_ohem_DRoiAlignX/detviplV7d0_test/zf_faster_rcnn_iter_100000_inference/detections.pkl'
...
if __name__ == '__main__':
    tattooShowBox('detviplV7d0_2016_test')
