...
if __name__ == '__main__':
    ...
    for i in range(10, 9, -1):
        print("Iteration", i)
        cacheFilename = \
             'output/pvanet_full1_ohem_DRoiAlignX/detviplV4d2_test/zf_faster_rcnn_iter_' + str(i) + '0000_inference/detections.pkl'
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('detviplV4d2-pvanet-ohem-DRoiAlignX-Ge50-' + str(i) +'.pkl')
