...
def showImage(im, boxes):
    ...
    threshold = [0, 0.87324089, 0.64497006, 0.53942692, 0.5864026]
...
def tattooShowBox(image_set):
    cache_file =  \
        'output/pvanet_full1_ohem_DRoiAlignX/detviplV5d0_test/zf_faster_rcnn_iter_100000_inference/detections.pkl'
...
if __name__ == '__main__':
    tattooShowBox('detviplV5d0_2016_test')
