...
if __name__ == '__main__':
    ...
    for i in range(10, 0, -1):
        print("Iteration", i)
        cacheFilename = \
             'output/pvanet_full1_ohem_DRoiAlign_800x1440/detviplV4d2XX_test/zf_faster_rcnn_iter_' + str(i) + '0000_inference/detections.pkl'
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('detviplV4d2XX-pvanet-ohem-DRoiAlign-' + str(i) +'.pkl')
