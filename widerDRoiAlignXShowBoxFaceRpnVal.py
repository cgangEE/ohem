...
def showBox(image_set):
    cache_file =  \
        'output/pvanet_full1_ohem_DRoiAlignX_Face_Rpn/wider_val/zf_faster_rcnn_iter_100000_inference/detections.pkl'
    ...
    for i in xrange(num_images):
        im_name = ['predFaceRpn'] + imdb.image_path_at(i).strip().split('/')[8:]
