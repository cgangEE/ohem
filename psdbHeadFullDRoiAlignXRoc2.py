...
if __name__ == '__main__':
    ...
    for i in range(1, 11, 1):
        print("Iteration", i)
        cacheFilename = \
               'output/pvanet_full1_DRoiAlignX_Head/psdbHead_test/zf_faster_rcnn_iter_' + str(i) + \
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_id = ('pedestrain', 'head')#, 'head-shoulder', 'upperbody')
            plot_curves(eval_result, det_id)


            det_file = os.path.join('psdbHead-pvanet-DRoiAlignX-' + str(i) +'.pkl')
