...
if __name__ == '__main__':
    ...
    for i in range(10, 11):
        print("Iteration", i)
        cacheFilename = \
             'output/pvanet_full1/detviplV4_test/detvipl_v4_90000_finetune/detections.pkl'
        ...
        if (os.path.exists(cacheFilename)):
            ...
            det_file = os.path.join('detviplV4-pvanet-ohem-finetune.pkl')
