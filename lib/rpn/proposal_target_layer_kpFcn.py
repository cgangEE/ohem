...
class ProposalTargetLayer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        # kp_targets
        top[5].reshape(ohem_size * 14, 1, 192, 192)
    ...
    def forward(self, bottom, top):
        ...
        # targets
        labels, rois, bbox_targets, bbox_inside_weights, kp_targets = \
            _sample_rois(
...
def _compute_kp_targets(ex_rois, gt_kps, labels):
    ...
    kp_targets = kps_transform(ex_rois, gt_kps, labels)
...
def _sample_rois(all_rois, gt_boxes, gt_kps, fg_rois_per_image, rois_per_image, num_classes):
    ...
    return labels, rois, bbox_targets, bbox_inside_weights, kp_targets
