...
class detviplV4(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'detviplV4_' + image_set)
        self._image_set = image_set
        self._data_path = os.path.join(cfg.DATA_DIR, 'detviplV4')
    ...
    def _get_annotation(self, index):
        ...
        filename = os.path.join(self._data_path, 'data-label1',  \
                    index[:-4] + '.txt')
