...
class sjtu_ia(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'sjtu_ia_' + image_set)
        self._image_set = image_set
        self._data_path = os.path.join(cfg.DATA_DIR, 'sjtu_ia')
    ...
    def _get_annotation(self, index):
        filename = os.path.join(self._data_path, 'label', index[5:-3]+'txt')
...
if __name__ == '__main__':
    my_cox_reid = sjtu_ia('train', '2016');
