...
class detviplV7d2d1(imdb):
    def __init__(self, image_set, year):
        imdb.__init__(self, 'detviplV7d2d1_' + image_set)
        self._image_set = image_set
        self._data_path = os.path.join(cfg.DATA_DIR, 'detviplV7d2d1')
